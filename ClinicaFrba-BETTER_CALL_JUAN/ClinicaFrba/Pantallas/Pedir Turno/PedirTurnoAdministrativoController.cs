...
{
    class PedirTurnoAdministrativoController
    {
         private Pedir_Turno_Administrativo form;

         public PedirTurnoAdministrativoController(Pedir_Turno_Administrativo form)
        {
            this.form = form;
        }
